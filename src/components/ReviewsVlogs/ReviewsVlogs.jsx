...
const ReviewsVlogs = () => {
  const vlog = {
    ...
    views: "750K",
    timeAgo: "4 days ago",
    thumbnail: "https://images.unsplash.com/photo-1517256064527-03b79502d775?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80",
    duration: "12:00",
  };
